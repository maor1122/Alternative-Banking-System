...
public class LoginController implements Closeable {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                if (response.code() != 200) {
                    ...
                    Platform.runLater(() -> {
                        ...
                        try {
                            switchToAdminScene(event,userName);
    ...
    public void switchToAdminScene(ActionEvent event,String userName) throws IOException{
        ...
        stage.setTitle("Admin DashTable");
